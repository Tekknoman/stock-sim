              ...
              <div className="mt-3 space-y-4 bg-dark-300 p-4 rounded-lg">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    <h4 className="text-sm font-semibold border-b border-dark-200 pb-1">
                      Trading Volume Decay
                    </h4>

                    <div>
                      <label
                        htmlFor="volume_decay_rate"
                    ...
                    <div>
                      <label
                        htmlFor="volume_decay_threshold"
                        className="block text-xs text-gray-400 mb-1"
                      >
                        Decay Threshold (minutes: 1-1440)
                      </label>
                      <input
                        type="number"
                      ...
                      />
                      <p className="text-xs text-gray-500 mt-1">
                        Minutes of inactivity before a stock starts to decay
                      </p>
                    </div>
                  </div>
